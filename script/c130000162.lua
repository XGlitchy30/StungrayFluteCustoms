...
function s.initial_effect(c)
	...
	● If this card is Normal Summoned: Place 1 counter on this card, and if you do, add 1 "B.E.F. Shield Machinery" from your Deck to your hand.]]
...
s.listed_names={CARD_BEF_SHIELD_MACHINERY}
...
function s.thfilter(c)
	return c:IsCode(CARD_BEF_SHIELD_MACHINERY) and c:IsAbleToHand()
end