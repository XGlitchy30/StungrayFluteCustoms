...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return aux.NumberLPCondition(e,tp,1000,0) and (Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated())
end
function s.rfilter(c)
	return c:IsMonsterType() and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c) 
